...
export const transitionQuotes = [
  ...
  "With you, ordinary moments felt magical.",
...
export const memories = [
  {
    ...
    date: "The Day We Met",
    title: "First Glance",
    description: "I didn't know it then, but my whole world changed the second you smiled.",
    emoji: "✨",
    rotate: -3,
    hiddenMessage: "I was so nervous, but your eyes made me feel like I was already home.",
  },
  {
    id: 2,
    date: "Our First Date",
    title: "Coffee & Butterflies",
    description: "Hours felt like minutes. We talked until the cafe closed, and I still didn't want to leave.",
    emoji: "☕",
    rotate: 4,
    hiddenMessage: "I kept looking at your hands and thinking about how much I wanted to hold them.",
  },
  {
    id: 3,
    date: "That Late Night Walk",
    title: "Under the Stars",
    description: "The city was quiet, the air was cool, and everything felt perfectly aligned.",
    emoji: "🌙",
    rotate: -5,
    hiddenMessage: "That was the night I realized I was falling for you.",
  },
  {
    id: 4,
    date: "Our First Trip",
    title: "Adventures Together",
    description: "Getting lost with you is my favorite way to find myself.",
    emoji: "✈️",
    rotate: 2,
    hiddenMessage: "I love how easily we fit into each other's lives, no matter where we are.",
  },
  {
    id: 5,
    date: "A Quiet Sunday",
    title: "Just Us",
    description: "No plans, nowhere to be. Just lazy mornings and the comfort of your presence.",
    emoji: "🥞",
    rotate: -4,
    hiddenMessage: "These are the moments I treasure most. The loud silence of just being together.",
  },
  {
    id: 6,
    date: "Today & Always",
    title: "Choosing You",
    description: "Every single day since we met, I've loved you a little more than the day before.",
    emoji: "💕",
    rotate: 3,
...
export const surpriseConfig = {
  ...
  spotifyLink: "https://open.spotify.com/playlist/02KCQXNHmxgcBkpnBYDJTw?si=a9r7VwDQT2OUHUq7TvYetA",
  carouselPhotos: [
...
export const galleryConfig = {
  ...
  photos: [
    ...
    { id: 9, caption: "A quiet moment", date: "[Date]", hiddenNote: "Even silence feels perfect when it's with you 🤍", rotate: -2, emoji: "🙆🏻‍♀️" },
...
export const countdownConfig = {
  // Set this to the birthday date — update year as needed
  targetDate: "2025-08-20T00:00:00",
  title: "Counting Down to Your Day ❤️",
  subtitle: "Every second brings us closer to another beautiful memory together.",
  message: "The most special day of the year — because it's the day you came into this world. 🎂",
};

export const scrapbookConfig = {
  heading: "Our Little Scrapbook",
  subheading: "A collection of moments that mean the world to me.",
  memories: [
    {
      id: 1,
      date: "[Date]",
      caption: "The beginning of everything",
      memory: "Some moments feel ordinary when they're happening. Looking back, this was anything but.",
      emoji: "🧸",
      rotate: -3,
      tapeRotate: -2,
    },
    {
      id: 2,
      date: "[Date]",
      caption: "My favorite kind of chaos",
      memory: "I love how perfectly we fit — even when everything is wonderfully messy.",
      emoji: "🎀",
      rotate: 2,
      tapeRotate: 1,
    },
    {
      ...
      memory: "If I could freeze one moment and live in it forever, it might just be this one.",
      emoji: "🧸",
      rotate: -4,
      tapeRotate: -1,
    },
    {
      id: 4,
      date: "[Date]",
      caption: "Us at our very best",
      memory: "This is what I mean when I say you make ordinary days feel extraordinary.",
      emoji: "✨",
      rotate: 3,
      tapeRotate: 2,
    },
    {
      id: 5,
      date: "[Date]",
      caption: "A quiet, perfect moment",
      memory: "No big plans. Just us. And somehow that was more than enough.",
      emoji: "🧸",
      rotate: -2,
      tapeRotate: -2,
    },
    {
      ...
      memory: "I would do it all again — every single part — just to end up right here with you.",
      emoji: "💌",
      rotate: 4,
      tapeRotate: 1,
    },
